...
$results=$catController->viewCat($catid);
if (isset($_POST['submit'])) {
	...
	$catController=new CatController();
	$catController->updateCat($catid,$name,$fullpath);
...
?>
	...
	<div class="row pt-3">
		<div class="col-md-12">
			<div class="form-group">
				<label>Photo</label>
				<input type="file" id="input2" name="photo" value="<?php echo $result['photo'];?>" class="form-control">
